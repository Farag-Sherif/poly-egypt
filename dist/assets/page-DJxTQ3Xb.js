import{r as n,j as e,A as l,f as o,a as d,p as m,b as c,L as h}from"./index-CbYcQA4W.js";import{H as f,F as x}from"./Header1-DZzveaK4.js";import{T as g}from"./Topbar6-LCxvdSmJ.js";function p({certificate:i}){const[a,t]=n.useState(!1),s=()=>{t(!0)};return e.jsxs("div",{className:"certificate-card",children:[e.jsxs("div",{className:"certificate-image-wrapper",children:[a?e.jsxs("div",{className:"certificate-placeholder",children:[e.jsx("i",{className:"icon-file-text"}),e.jsx("span",{children:"Certificate"})]}):e.jsx(l,{src:i.image_path,alt:i.title||"Certificate",width:400,height:300,className:"certificate-image",onError:s,priority:!1,loading:"lazy"}),e.jsx("div",{className:"certificate-overlay",children:e.jsx("button",{className:"btn-view-certificate",onClick:()=>window.open(i.image_path,"_blank"),"aria-label":`View ${i.title}`,children:e.jsx("i",{className:"icon-eye"})})})]}),e.jsx("div",{className:"certificate-content",children:e.jsx("h3",{className:"certificate-title",children:i.title})}),e.jsx("style",{children:`
        .certificate-card {
          background: #fff;
          border-radius: 12px;
          overflow: hidden;
