...
export const metadata = {
  title:
    "Product Detail Description fullwidth || PolyEgy - Multipurpose React React eCommerce Template",
  description: "PolyEgy - Multipurpose React React eCommerce Template",
};
