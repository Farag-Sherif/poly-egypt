import { testimonialsWithProduct6 } from "@/data/products";
  ...
  return (
    <section className="flat-spacing pt-0">
      <div className="container">
        ...
        >
          {testimonialsWithProduct6.map((testimonial, index) => (
          ...
          <div className="sw-pagination-testimonial sw-dots type-circle d-flex justify-content-center spd69" />
        </Swiper>
      </div>
    </section>
  );
